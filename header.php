...
<!-- Custom styles for this template -->
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top"><img style="width:180px;" clas="img-responsive convectium-logo" src="<?php echo get_template_directory_uri(); ?>/img/convectium-logo.png"></a>
